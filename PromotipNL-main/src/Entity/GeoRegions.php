 ...
 * GeoRegions
 *
 * @ORM\Table(name="geo_regions", indexes={@ORM\Index(name="iso", columns={"iso"}), @ORM\Index(name="iso2", columns={"iso2"}), @ORM\Index(name="iso_2", columns={"iso", "name", "region_language"}), @ORM\Index(name="language", columns={"language", "iso2"}), @ORM\Index(name="name_dirify", columns={"name_dirify"})})
 * @ORM\Entity
 */
class GeoRegions
{
