 ...
 * GeoPlaces
 *
 * @ORM\Table(name="geo_places", indexes={@ORM\Index(name="id", columns={"id"}), @ORM\Index(name="iso", columns={"iso"}), @ORM\Index(name="iso_2", columns={"iso", "locality", "postcode"}), @ORM\Index(name="locality_dirify", columns={"locality_dirify"})})
 * @ORM\Entity(repositoryClass="App\Repository\GeoPlacesRepository")
 */
class GeoPlaces
{
    /**
