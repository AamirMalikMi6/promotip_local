...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EventadvertRepository")
 */
class Eventadvert
{
    /**
     ...
     *      min = 2,
     *      max = 128,
     *      minMessage = "Your event title name must be at least {{ limit }} characters long",
     *      maxMessage = "Your event title cannot be longer than {{ limit }} characters",
     ...
     *      min = 1,
     *      max = 8,
     *      minMessage = "Your housenumber must be at least {{ limit }} characters long",
     *      maxMessage = "Your housenumber cannot be longer than {{ limit }} characters",
     *      allowEmptyString = true
     * )
     */
    private $housenumber;
     ...
     *      min = 1,
     *      max = 8,
     *      minMessage = "Your box must be at least {{ limit }} characters long",
     *      maxMessage = "Your box cannot be longer than {{ limit }} characters",
     *      allowEmptyString = true
     * )
     */
    private $box;
     ...
     *      min = 1,
     *      max = 24,
     *      minMessage = "Please select your location",
     *      maxMessage = "Please select your location",
     *      allowEmptyString = true
     * )
     */
    private $geoPlacesId;
