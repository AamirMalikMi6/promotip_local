...
{
    protected static $defaultName = 'promotip:check-end-advert-premium';
    ...
    {
        $this->setDescription('Check end of premium advert and send link to renew it');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $paidAdverts = $this->eventAdvertRepository->getPaidAdvertWithDatePaid();
        ...
        if (count($paidAdverts) > 0) {
            foreach ($paidAdverts as $paidAdvert) {
                ...
                if ($expiredDate == $now || $expiredDate < $now) {
