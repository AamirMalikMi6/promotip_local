...
class AdvertController extends AbstractController
{
    ...
    )
    {
        ...
        if ( $request->request->has('radius') || $request->request->get('postcode')  ) $hasSearchQuery = true;
        ...
        $data = $this->getData($deletedUsers, $request->getLocale(), $categories, $channelRepository, $categoryRepository, $eventadvertRepository, $geoPlacesRepository,
            $geoRegionsRepository, $paginator, $request, $date_event_start_from, $date_event_start_to, $date_event_end_from, $date_event_end_to, $location, $radius_query);
     ...
     * @Route({
     *     "en": "/sales/{category}/",
     *     "nl": "/promoties/{category}/",
     *     "fr": "/promotions/{category}/"
     * }, name="sales_category")
     */
    ...
    /**
     * @Route({
     *     "en": "/local-stores/{category}/",
     *     "nl": "/handelaars/{category}/",
     *     "fr": "/marchands/{category}/"
     * }, name="local_stores_category")
     */
    ...
    /**
     * @Route({
     *     "en": "/sales/{category}/{slug}.html",
     *     "nl": "/promoties/{category}/{slug}.html",
     *     "fr": "/promotions/{category}/{slug}.html"
     * }, name="sales_advert")
     */
    ...
    )
    {
        ...
        if ( !$event )
        {
            ...
            if ($event->getGeoPlacesId() > 0) {
                $geo = $event->getGeoPlacesId();
            } else {
            ...
            if ( $event->getPaymentStatus() == 'paid' && !empty($event->getPlan()) && !empty($event->getPaidDate()) && ($event->getPaidDate() < $now) ) 
            {
                ...
                if ( !in_array( $event->getPlan(), $bigPremiumOptions ))
                {
    ...
    /**
     * @Route({
     *     "en": "/events/{category}/{slug}.html",
     *     "nl": "/evenementen/{category}/{slug}.html",
     *     "fr": "/evenements/{category}/{slug}.html"
     * }, name="events_advert")
     */
    ...
    /**
     * @Route({
     *     "en": "/local-stores/{category}/{slug}.html",
     *     "nl": "/handelaars/{category}/{slug}.html",
     *     "fr": "/marchands/{category}/{slug}.html"
     * }, name="local_stores_advert")
     */
    ...
    )
    {
        ...
        if ( count($eventsQb) > 0) {
            ...
            if (!empty($latestEvents)) $geoPlaces = $geoPlacesRepository->findByIdsAndLocale($geoPlacesIds, $locale);
        }
    ...
    /**
     * @Route({
     *     "en": "/getMostViewedAdvertsFooter",
     *     "nl": "/getMostViewedAdvertsFooter",
     *     "fr": "/getMostViewedAdvertsFooter"
     * }, name="getMostViewedAdvertsFooter")
     */
    ...
    /**
     * @Route({
     *     "en": "/getMostUsedKeywordsFooter",
     *     "nl": "/getMostUsedKeywordsFooter",
     *     "fr": "/getMostUsedKeywordsFooter"
     * }, name="getMostUsedKeywordsFooter")
     */
    ...
    private static function sortItems($element1, $element2)
    {
