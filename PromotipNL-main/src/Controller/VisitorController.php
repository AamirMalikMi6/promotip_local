...
class VisitorController extends AbstractController
{
     ...
     * }, name="ajax_vAuth")
     */
    public function vAuth(Request $request, VisitorRepository $repository, SessionInterface $session)
    {
     ...
     * }, name="submit_vReview")
     */
    public function vReview(Request $request, VisitorRepository $repository, SessionInterface $session, CompanyRepository $companyRepository)
    {
        // check if email already exists
