...
class PasswordForgottenController extends AbstractController
{
     ...
     *     "nl": "/paswoord-vergeten/",
     *     "fr": "/mot-de-passe-oublie/"
     * }, name="password_forgotten")
     */
    public function index(Request $request, TranslatorInterface $translator, MailerInterface $mailer)
    {
        //  pwd forgotten form
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $repository_pwd = $this->getDoctrine()->getRepository(PasswordForgotten::class);
     ...
     * @Route({
     *     "en": "/password-reset/",
     *     "nl": "/paswoord-instellen/",
     *     "fr": "/nouveau-mot-de-passe/"
     * }, name="password_reset")
     */
    public function setPassword(Request $request, TranslatorInterface $translator, UserPasswordEncoderInterface $passwordEncoder)
    {
