...
class SitemapController extends AbstractController
{
    ...
    /**
     * @Route("/sitemap-algemeen.xml", name="sitemap-general", defaults={"_format"="xml"})
     */
    ...
    /**
     * @Route("/sitemap-bedrijven.xml", name="sitemap-companies", defaults={"_format"="xml"})
     */
    ...
    /**
     * @Route("/sitemap-evenementen.xml", name="sitemap-events", defaults={"_format"="xml"})
     */
