...
class CalendarController extends AbstractController
{
     ...
     *     "nl": "/dashboard/kalender/",
     *     "fr": "/dashboard/calendrier/"
    ...
    /**
     * @Route({
     *     "en": "/dashboard/calendar/events",
     *     "nl": "/dashboard/kalender/events",
     *     "fr": "/dashboard/calendrier/events"
     * }, name="dashboard_calendar_events")
     */
    public function events(Request $request, UserInterface $user, CompanyRepository $companyRepository, EventadvertRepository $eventadvertRepository)
    {
        $calendarEvents = [];
        $userId = $user->getId();
        $company = $companyRepository->findOneBy(['userId' => $userId]);
