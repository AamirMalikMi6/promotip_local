...
class CompanyController extends AbstractController
{
    /**
     * @Route({
     *     "en": "/dashboard/company/",
     *     "nl": "/dashboard/bedrijf/",
     *     "fr": "/dashboard/entreprise/"
     * }, name="dashboard_company")
     */
    public function index(Request $request, UserInterface $user, CompanyRepository $companyRepository, GeoPlacesRepository $geoPlacesRepository)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($company->getGeoplacesId() !== null) {
                if ($data = $geoPlacesRepository->findByIdAndLocale($company->getGeoplacesId(), $request->getLocale())) {
                    ...
                    $company->setLocalityDirify($data[0]->getLocalityDirify());
                }
            }
    ...
    /**
     * @Route({
     *     "en": "/dashboard/company/preview",
     *     "nl": "/dashboard/bedrijf/voorvertoning",
     *     "fr": "/dashboard/entreprise/avant-premiere"
     * }, name="dashboard_company_preview")
     */
    public function preview(Request $request, UserInterface $user, CompanyRepository $companyRepository)
    {
    ...
    /**
     * @Route({
     *     "en": "/dashboard/company/photos",
     *     "nl": "/dashboard/bedrijf/fotos",
     *     "fr": "/dashboard/entreprise/photos"
     * }, name="dashboard_company_photos")
     */
    public function photos(Request $request, CompanyRepository $companyRepository, UserInterface $user)
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route({
     *     "en": "/dashboard/company/delete-photo",
     *     "nl": "/dashboard/bedrijf/verwijder-foto",
     *     "fr": "/dashboard/entreprise/supprimer-photo"
     * }, name="dashboard_company_photos_delete")
     */
    public function photoDelete(Request $request, CompanyRepository $companyRepository, UserInterface $user)
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route({
     *     "en": "/dashboard/company/move-photo",
     *     "nl": "/dashboard/bedrijf/verplaats-foto",
     *     "fr": "/dashboard/entreprise/bouger-photo"
     * }, name="dashboard_company_photos_move")
     */
    public function photoMove(Request $request, CompanyRepository $companyRepository, UserInterface $user)
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route({
     *     "en": "/dashboard/company/photo",
     *     "nl": "/dashboard/bedrijf/foto",
     *     "fr": "/dashboard/entreprise/photo"
     * }, name="dashboard_company_photo_template")
     */
    public function photoTemplate(Request $request, CompanyRepository $companyRepository, UserInterface $user)
    {
        $photoReturn = false;
        $entityManager = $this->getDoctrine()->getManager();
        ...
        return $this->redirectToRoute('dashboard_event', ['action' => 'companyprofile']);
