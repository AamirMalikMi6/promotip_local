...
class ChatController extends AbstractController
{
     ...
     * @Route({
     *     "en": "/dashboard/chat/",
     *     "nl": "/dashboard/berichten/",
     *     "fr": "/dashboard/messagerie/"
     * }, name="dashboard_chat")
     */
    ...
    /**
     * @Route({
     *     "en": "/dashboard/chat/{messageId}",
     *     "nl": "/dashboard/berichten/{messageId}",
     *     "fr": "/dashboard/messagerie/{messageId}"
     * }, name="dashboard_view_message")
     */
    public function viewMessage(int $messageId, MessagesRepository $messagesRepository, UserInterface $user): Response
    {
        /** @var Message $message */
    ...
    /**
     * @Route({
     *     "en": "/dashboard/chat/delete/{messageId}",
     *     "nl": "/dashboard/berichten/delete/{messageId}",
     *     "fr": "/dashboard/messagerie/delete/{messageId}"
     * }, name="dashboard_delete_message")
     */
    public function deleteMessage(int $messageId, MessagesRepository $messagesRepository, UserInterface $user): Response
    {
        /** @var Message $message */
        $message = $messagesRepository->find($messageId);
