...
(function ($) {
	$.cookieBubble = function (options) {
			...
			var settings = $.extend({	
				cookieMaxAge  							: 30, 
				messageText								: 'We gebruiken cookies om uw ervaring te personaliseren. Door verder te gaan met het bezoeken van deze website gaat u akkoord met ons gebruik van cookies.',
				...
				iconColor								: undefined,    			 
				iconVisibility		  					: true, 		              
				cookiePolicyButtonText					: 'Lees ons cookiebeleid',
				cookiePolicyButtonTextColor		    	: undefined,
				cookiePolicyButtonUrl					: window.cookiePolicyButtonUrl,
